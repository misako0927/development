...
-	oscm-file-billing-adapter.ear - adapts external billing to be useful in OSCM
...
Deployment and configuration sample billing applications.
    ...
    1. Set up portal according to guides provided within the install-pack.
    2. Deploy oscm-file-billing mock application.
    3. Deploy oscm-file-billing-adapter and configure it. Assuming that oscm-file-billing application is
    ...
    4. Save the config file and reload the application using asadmin commanline application or administration console.
...
Billing adapter must be registered in the OSCM in order to use freshly deployed billing system delivered with it.
    ...
    2. In the Operation -> Manage billing adapters section, add a new billing adapter with the following values in the fields:
        ...
        JNDI_NAME:                          java:global/oscm-file-adapter/oscm-file-adapter/FileBillingAdapter
    ...
    3. Test connection by clicking 'Test connection' button on the Manage billing adapters page.
